...
class VaeBlstm_v3(BaseNetwork):
    ...
    def __init__(self, sampleDim, segLen_max, mConfig):
        ...
        super(VaeBlstm_v3, self).__init__(sampleDim, mConfig)
    ...
    def buildBlstm(self):
        self.prediction = blstmFramePredictionNetwork(self.reconstruction_vae, self.placeHolder_seqLens, self.segLen_max, self.classNumAll, self.mConfig.blstmLayerNum, self.mConfig.blstmLayerNeuronNum)
