...
class VaeBlstm_v14(BaseNetwork):
    '''
    classdocs
    '''
    ...
    def __init__(self, sampleDim, segLen_max, mConfig):
        ...
        super(VaeBlstm_v14, self).__init__(sampleDim, mConfig)
    ...
    def buildNet(self):
        ...
        self.variables_to_restore = None#[v for v in self.params if v.name.find('vae') >= 0] 
