...
from Model.Model1 import oneLayerBidirectionalLstmEncoder, vaeSampler,\
    ...
    twoLayerFcEncoder, twoLayerFcDecoder, twoLayerFcEncoder_norm,\
    normalEncoderLoss
...
class VaeBlstm_v16(BaseNetwork):
    '''
    classdocs
    '''
    ...
    def __init__(self, sampleDim, segLen_max, mConfig):
        ...
        super(VaeBlstm_v16, self).__init__(sampleDim, mConfig)
    ...
    def buildNet(self):
        ...
        self.Z = twoLayerFcEncoder_norm(self.sample_forEncoder, self.hiddenDim_vae_encoder, self.hiddenDim_vae_z)
        ...
        self.loss_vae = normalEncoderLoss(self.reconstruction_vae, self.placeHolder_targets_reconstruction)
