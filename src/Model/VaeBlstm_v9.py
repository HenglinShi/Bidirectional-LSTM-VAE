...
class VaeBlstm_v9(BaseNetwork):
    ...
    def __init__(self, sampleDim, segLen_max, mConfig):
        ...
        super(VaeBlstm_v9, self).__init__(sampleDim, mConfig)
    ...
    def trainOneEpoch(self):
        ...
        for batchIte in range(self.batchLoader_train.getBatchNumPerEpoch()):
            ...
            [sampleBatch_train, frameLabelBatch_train, seqlenBatch_train,\
             reconstructionBatch_train] = self.batchLoader_train.getNextBatch()
            ...
            currentFeed = {self.placeHolder_samples: sampleBatch_train, \
                           self.placeHolder_targets_reconstruction: reconstructionBatch_train, \
    ...
    def testOneEpoch(self):
        ...
        for batchIte in range(self.batchLoader_test.getBatchNumPerEpoch()):
            ...
            currentFeed = {self.placeHolder_samples: sampleBatch_test, \
                           self.placeHolder_targets_reconstruction: reconstructionBatch_test, \
