...
class VaeBlstm_v8(BaseNetwork):
    ...
    def buildBlstm(self):
        self.prediction = blstmSequencePredictionNetwork(self.Z, self.placeHolder_seqLens, self.segLen_max, \
    ...
    def trainOneEpoch(self):
        ...
        for batchIte in range(self.batchLoader_train.getBatchNumPerEpoch()):
            ...
            [sampleBatch_train, frameLabelBatch_train, seqlenBatch_train, reconstructionBatch_train] = self.batchLoader_train.getNextBatch()
            ...
            currentFeed = {self.placeHolder_samples: sampleBatch_train, self.placeHolder_targets_reconstruction: reconstructionBatch_train, \
    ...
    def testOneEpoch(self):
        ...
        for batchIte in range(self.batchLoader_test.getBatchNumPerEpoch()):
            [sampleBatch_test, frameLabelBatch_test, seqlenBatch_test, reconstructionBatch_test] = self.batchLoader_test.getNextBatch()
            ...
            currentFeed = {self.placeHolder_samples: sampleBatch_test, self.placeHolder_targets_reconstruction: reconstructionBatch_test, \
        ...
        return [loss_currentTestEpoch / self.batchLoader_test.getBatchNumPerEpoch(), \
                correctPredictNum_currentTestEpoch.sum() * 1.0 / sequenceLengths_currentTestEpoch.sum()]
